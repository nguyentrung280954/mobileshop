					...
					<div class="product">
						...
						<div class="col-md-6">
							<div class="caption">
								...
								<input type="submit" name="submit" class="btn btn-2" value="Thêm vào giỏ hàng" />
      ...
      <div class="modal-content">
		...
		<input type="text" class="form-control" placeholder="Tên:" name="name" id="name" required>
						...
						<label> Hình thức thanh toán :<select class="selectpicker" name="hinhthuctt">
    										<option value="ATM">Thanh toán Online</option>
							...
							<div id="review" class="tab-pane fade">
							  <div class="review-form">
								<form name="form1" id="ff" method="post" action="review.php">
									<label>
									<span>Bình luận:</span>
									<div class="fb-comments" data-href="https://www.facebook.com/nt.trung.280954/" data-numposts="5"></div>
									</label>
								</form>
							  </div>
							</div>
