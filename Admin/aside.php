        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../images/logogggg.png" class="img-circle" alt="User Image">
            </div>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                <li class="active"><a href="index.php"><i class="fa fa-dashboard"></i> Trang quản trị</a></li>
            </li>
            <li class="treeview">
              <a href="#">
              ...
              <ul class="treeview-menu">
                <li><a href="qlysanpham.php"><i class="fa fa-circle-o"></i> Quản lý sản phẩm</a></li>
                <li><a href="qlynhasx.php"><i class="fa fa-circle-o"></i> Quản lý nhà sản xuất</a></li>
